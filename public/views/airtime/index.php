	    ...
	    <div class="container">
    		<div class="d-flex flex-wrap justify-content-between align-items-center mb-1">
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <a href="javascript:;" data-toggle="modal" data-target="#add-airtime" class="text-muted mb-3 mr-2 bg-white shadow-sm btn btn-sm rounded-pill px-4">
                            Add Airtime
                        </a>
                        <?php require VIEWS_PATH . DS . 'machines' . DS . 'partials' . DS . 'add.php'; ?>
                    </div>
                </div>
                <div class="d-flex align-items-center flex-wrap">
            ...
            <?php if(empty($allAirtime)): ?>
                <div class="alert alert-info">No Airtime Transactions Yet.</div>
            <?php else: ?>
                <div class="row">
                    <?php foreach($allAirtime as $airtime): ?>
                        <?php require VIEWS_PATH . DS . 'machines' . DS . 'partials' . DS . 'listings.php'; ?>
                    <?php endforeach; ?>
                </div>
                <?php foreach($allAirtime as $airtime): ?>
                    <?php require VIEWS_PATH . DS . 'machines' . DS . 'partials' . DS . 'edit.php'; ?>
                <?php endforeach; ?>
            <?php endif; ?>
	    </div>
    </div>
