	    ...
	    <div class="container">
    		<div class="d-flex flex-wrap justify-content-between align-items-center mb-1">
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <a href="javascript:;" data-toggle="modal" data-target="#add-machine" class="text-muted mb-3 mr-2 bg-white shadow-sm btn btn-sm rounded-pill px-4">
                            Add Machine
                        </a>
            ...
            <?php if(empty($allMachines)): ?>
                <div class="alert alert-info">No POS Machines Yet.</div>
            <?php else: ?>
                <div class="row">
