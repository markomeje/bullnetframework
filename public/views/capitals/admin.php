	    ...
	    <div class="container">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-1">
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <a href="javascript:;" data-toggle="modal" data-target="#add-capital" class="text-muted mb-3 mr-2 bg-white shadow-sm btn btn-sm rounded-pill px-4">
                        Add Capital
                    </a>
                    <?php require VIEWS_PATH . DS . "capitals" . DS . "partials" . DS . "add.php"; ?>
                    <a href="<?= DOMAIN; ?>/capitals" class="text-muted mb-3 mr-2 bg-white shadow-sm btn btn-sm rounded-pill px-4">
                        All Capitals
                    </a>
                </div>
                <div class="d-flex align-items-center flex-wrap">
            ...
            <?php if(empty($allAdminCapitals)): ?>
                <div class="alert alert-info">No Capitals Yet</div>
            <?php else: ?>
                <div class="row">
                    <?php foreach($allAdminCapitals as $capital): ?>
                        <?php require VIEWS_PATH . DS . 'capitals' . DS . 'partials' . DS . 'listings.php'; ?>
                    <?php endforeach; ?>
                </div>
                <?php foreach($allAdminCapitals as $capital): ?>
                    <?php require VIEWS_PATH . DS . 'capitals' . DS . 'partials' . DS . 'edit.php'; ?>
                <?php endforeach; ?>
            <?php endif; ?>
	    </div>
    </div>
