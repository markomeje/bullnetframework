<div class="modal fade" id="add-capital" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered border-raduis-lg" role="document">
        <div class="modal-content border-raduis-lg">
            <form method="post" action="javascript:;" class="add-capital-form" data-action="<?= DOMAIN; ?>/capitals/add" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="alert mb-3 add-capital-message d-none"></div>
                    <div class="d-flex float-right mb-4 mt-2">
                        <button type="submit" class="btn btn-lg bg-blueviolet text-white add-capital-button px-4">
                            <img src="<?= PUBLIC_URL; ?>/images/svgs/spinner.svg" class="mr-2 d-none add-capital-spinner mb-1">
                            Submit
                        </button>
