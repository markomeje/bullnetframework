	    ...
	    <div class="container">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-1"> 
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <a href="javascript:;" data-toggle="modal" data-target="#add-product" class="text-muted mb-3 mr-2 bg-white shadow-sm btn btn-sm rounded-pill px-4">
                        Add Product
                    </a>
                    <?php require VIEWS_PATH . DS . 'products' . DS . 'partials' . DS . 'add.php'; ?>
                </div>
                <div class="d-flex align-items-center flex-wrap">
            ...
            <?php else: ?>
                <div class="row">
                    <?php foreach($allProducts as $product): ?>
                        <?php require VIEWS_PATH . DS . 'products' . DS . 'partials' . DS . 'listings.php'; ?>
                    <?php endforeach; ?>
                </div>
                <?php foreach($allProducts as $product): ?>
                    <?php require VIEWS_PATH . DS . 'products' . DS . 'partials' . DS . 'edit.php'; ?>
                <?php endforeach; ?>
            <?php endif; ?>
	    </div>
    </div>
