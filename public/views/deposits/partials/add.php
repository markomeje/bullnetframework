<div class="modal fade" id="add-deposit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered border-raduis-lg" role="document">
        <div class="modal-content border-raduis-lg">
            <form method="post" action="javascript:;" class="add-deposit-form" data-action="<?= DOMAIN; ?>/deposits/add" autocomplete="off">
                <div class="modal-body">
                    <div class="d-flex justify-content-between pb-2 mb-3 border-bottom">
                        <p class="modal-title text-muted mb-0">Add Deposit</p>
                    ...
                    <div class="form-row">
						<div class="form-group input-group-lg col-md-6">
							<label for="" class="text-muted mb-2">Account Number</label>
							<input type="text" name="accountnumber" class="form-control form-control-lg accountnumber" placeholder="e.g., 3081243188">
					...
					<div class="form-row">
                        <div class="form-group col-md-6">
							<label class="text-muted mb-2">Deposit Amount</label>
                    ...
                    <div class="alert mb-3 add-deposit-message d-none"></div>
                    <div class="d-flex float-right mb-4 mt-2">
                        <button type="submit" class="btn btn-lg bg-blueviolet text-white add-deposit-button px-4">
                            <img src="<?= PUBLIC_URL; ?>/images/svgs/spinner.svg" class="mr-2 d-none add-deposit-spinner mb-1">
                            Submit
                        </button>
